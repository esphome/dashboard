...
export const boardSelectOptions = html`
  ...
  <optgroup label="ESP32-S2">
    <option value="featheresp32-s2">Adafruit ESP32-S2 Feather Development Board</option>
    <option value="adafruit_feather_esp32s2_tft">Adafruit Feather ESP32-S2 TFT</option>
    <option value="adafruit_funhouse_esp32s2">Adafruit FunHouse</option>
    <option value="adafruit_magtag29_esp32s2">Adafruit MagTag 2.9</option>
    <option value="adafruit_metro_esp32s2">Adafruit Metro ESP32-S2</option>
    <option value="adafruit_qtpy_esp32s2">Adafruit QT Py ESP32-S2</option>
    <option value="nodemcu-32s2">Ai-Thinker NodeMCU-32S2 (ESP-12K)</option>
    <option value="deneyapmini">Deneyap Mini</option>
    <option value="minimain_esp32s2">Deparment of Alchemy MiniMain ESP32-S2</option>
    <option value="atmegazero_esp32s2">EspinalLab ATMegaZero ESP32-S2</option>
    <option value="esp32-s2-kaluga-1">Espressif ESP32-S2-Kaluga-1 Kit</option>
    <option value="esp32-s2-saola-1">Espressif ESP32-S2-Saola-1</option>
    <option value="esp32-s2-franzininho">Franzininho WiFi Board</option>
    <option value="franzininho_wifi_msc_esp32s2">Franzininho WiFi MSC</option>
    <option value="franzininho_wifi_esp32s2">Franzininho WiFi</option>
    <option value="micros2">microS2</option>
    <option value="bee_motion">Smart Bee Motion</option>
    <option value="sparkfun_esp32s2_thing_plus">SparkFun ESP32-S2 Thing Plus</option>
    <option value="um_feathers2_neo">Unexpected Maker FeatherS2 Neo</option>
    <option value="um_feathers2">Unexpected Maker FeatherS2</option>
    <option value="um_rmp">Unexpected Maker RMP</option>
    <option value="um_tinys2">Unexpected Maker TinyS2</option>
    <option value="lolin_s2_mini">WEMOS LOLIN S2 Mini</option>
    <option value="lolin_s2_pico">WEMOS LOLIN S2 PICO</option>
  </optgroup>
  <optgroup label="ESP32-S3">
    <option value="adafruit_feather_esp32s3">Adafruit Feather ESP32-S3 2MB PSRAM</option>
    <option value="adafruit_feather_esp32s3_nopsram">Adafruit Feather ESP32-S3 No PSRAM</option>
    <option value="adafruit_feather_esp32s3_tft">Adafruit Feather ESP32-S3 TFT</option>
    <option value="adafruit_qtpy_esp32s3_nopsram">Adafruit QT Py ESP32-S3 No PSRAM</option>
    <option value="wifiduino32s3">Blinker WiFiduino32S3</option>
    <option value="dfrobot_firebeetle2_esp32s3">DFRobot Firebeetle 2 ESP32-S3</option>
    <option value="esp32s3camlcd">ESP32S3 CAM LCD</option>
    <option value="esp32s3box">Espressif ESP32-S3-Box</option>
    <option value="esp32-s3-devkitc-1">Espressif ESP32-S3-DevKitC-1-N8 (8 MB QD, No PSRAM)</option>
    <option value="bee_motion_s3">Smart Bee Motion S3</option>
    <option value="bee_s3">Smart Bee S3</option>
    <option value="tamc_termod_s3">TAMC Termod S3</option>
    <option value="um_feathers3">Unexpected Maker FeatherS3</option>
    <option value="um_pros3">Unexpected Maker PROS3</option>
    <option value="um_tinys3">Unexpected Maker TinyS3</option>
    <option value="unphone8">unPhone 8</option>
    <option value="unphone9">unPhone 9</option>
    <option value="lolin_s3">WEMOS LOLIN S3</option>
  </optgroup>
`;

...
export const boardSelectOptions = html`
  ...
  <optgroup label="ESP32-C3">
    <option value="adafruit_qtpy_esp32c3">adafruit_qtpy_esp32c3</option>
    <option value="airm2m_core_esp32c3">airm2m_core_esp32c3</option>
    <option value="bee_motion_mini">bee_motion_mini</option>
    <option value="deneyapkartg">deneyapkartg</option>
    <option value="dfrobot_beetle_esp32c3">dfrobot_beetle_esp32c3</option>
    <option value="esp32-c3-devkitm-1">esp32-c3-devkitm-1</option>
    <option value="lolin_c3_mini">lolin_c3_mini</option>
    <option value="seeed_xiao_esp32c3">seeed_xiao_esp32c3</option>
    <option value="ttgo-t-oi-plus">ttgo-t-oi-plus</option>
    <option value="wifiduino32c3">wifiduino32c3</option>
  </optgroup>
  <optgroup label="ESP32-S2">
    <option value="adafruit_feather_esp32s2_tft">adafruit_feather_esp32s2_tft</option>
    <option value="adafruit_funhouse_esp32s2">adafruit_funhouse_esp32s2</option>
    <option value="adafruit_magtag29_esp32s2">adafruit_magtag29_esp32s2</option>
    <option value="adafruit_metro_esp32s2">adafruit_metro_esp32s2</option>
    <option value="adafruit_qtpy_esp32s2">adafruit_qtpy_esp32s2</option>
    <option value="atmegazero_esp32s2">atmegazero_esp32s2</option>
    <option value="bee_motion">bee_motion</option>
    <option value="deneyapmini">deneyapmini</option>
    <option value="esp32-s2-franzininho">esp32-s2-franzininho</option>
    <option value="esp32-s2-kaluga-1">esp32-s2-kaluga-1</option>
    <option value="esp32-s2-saola-1">esp32-s2-saola-1</option>
    <option value="featheresp32-s2">featheresp32-s2</option>
    <option value="franzininho_wifi_esp32s2">franzininho_wifi_esp32s2</option>
    <option value="franzininho_wifi_msc_esp32s2">franzininho_wifi_msc_esp32s2</option>
    <option value="lolin_s2_mini">lolin_s2_mini</option>
    <option value="lolin_s2_pico">lolin_s2_pico</option>
    <option value="micros2">micros2</option>
    <option value="minimain_esp32s2">minimain_esp32s2</option>
    <option value="nodemcu-32s2">nodemcu-32s2</option>
    <option value="sparkfun_esp32s2_thing_plus">sparkfun_esp32s2_thing_plus</option>
    <option value="um_feathers2_neo">um_feathers2_neo</option>
    <option value="um_feathers2">um_feathers2</option>
    <option value="um_rmp">um_rmp</option>
    <option value="um_tinys2">um_tinys2</option>
  </optgroup>
  <optgroup label="ESP32-S3">
    <option value="adafruit_feather_esp32s3_nopsram">adafruit_feather_esp32s3_nopsram</option>
    <option value="adafruit_feather_esp32s3_tft">adafruit_feather_esp32s3_tft</option>
    <option value="adafruit_feather_esp32s3">adafruit_feather_esp32s3</option>
    <option value="adafruit_qtpy_esp32s3_nopsram">adafruit_qtpy_esp32s3_nopsram</option>
    <option value="bee_motion_s3">bee_motion_s3</option>
    <option value="bee_s3">bee_s3</option>
    <option value="dfrobot_firebeetle2_esp32s3">dfrobot_firebeetle2_esp32s3</option>
    <option value="esp32-s3-devkitc-1">esp32-s3-devkitc-1</option>
    <option value="esp32s3box">esp32s3box</option>
    <option value="esp32s3camlcd">esp32s3camlcd</option>
    <option value="lolin_s3">lolin_s3</option>
    <option value="tamc_termod_s3">tamc_termod_s3</option>
    <option value="um_feathers3">um_feathers3</option>
    <option value="um_pros3">um_pros3</option>
    <option value="um_tinys3">um_tinys3</option>
    <option value="unphone8">unphone8</option>
    <option value="unphone9">unphone9</option>
    <option value="wifiduino32s3">wifiduino32s3</option>
  </optgroup>
`;
